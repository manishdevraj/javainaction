...
public class JQueue {
	...
	public static void main(String[] args) {
		...
		JQueue jQueue = new JQueue(10);

		jQueue.priorityInsert("16");

		jQueue.priorityInsert("25");

		jQueue.priorityInsert("10");
		...
		*/
		...
		jQueue.priorityInsert("35");

		jQueue.priorityInsert("5");
